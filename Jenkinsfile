pipeline {
  ...
  stages {
    ...
    stage('L2: Megatron RETRO Pretraining and Resume Training') {
      ...
      failFast true
      steps {
        sh "tests/jenkins/megatron_retro_pretraining_and_resume_training.sh"
      }
    }
    ...
    stage('L2: Megatron T5 Pretraining and Resume Training TP=2') {
      ...
      failFast true
      steps {
        sh "tests/jenkins/megatron_t5_pretraining_and_resume_training_tp_2.sh"
      }
    }
    stage('L2: Megatron T5 Pretraining and Resume Training PP=2') {
      ...
      failFast true
      steps {
        sh "tests/jenkins/megatron_t5_pretraining_and_resume_training_pp_2.sh"
      }
    }
